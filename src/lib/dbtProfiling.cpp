...
static inline long __internal_syscall(long n, long _a0, long _a1, long _a2, long _a3)
{
...
static int Begin_Time, End_Time;

void startProfiler(int id)
{

  __internal_syscall(SYS_PROFILING_START, id, 0, 0, 0);
  //	Begin_Time = rdcycle();
}
...
void stopProfiler(int id)
{
  ...
  __internal_syscall(SYS_PROFILING_STOP, id, 0, 0, 0);
  //		End_Time = rdcycle();
}
...
int getProfilingInfo(int id)
{
  ...
  return __internal_syscall(SYS_PROFILING_GET, id, 0, 0, 0);
