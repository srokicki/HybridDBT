...
const unsigned int shiftMask[32] = {0xffffffff, 0x7fffffff, 0x3fffffff, 0x1fffffff, 0xfffffff, 0x7ffffff, 0x3ffffff,
                                    0x1ffffff,  0xffffff,   0x7fffff,   0x3fffff,   0x1fffff,  0xfffff,   0x7ffff,
                                    0x3ffff,    0x1ffff,    0xffff,     0x7fff,     0x3fff,    0x1fff,    0xfff,
                                    0x7ff,      0x3ff,      0x1ff,      0xff,       0x7f,      0x3f,      0x1f,
                                    0xf,        0x7,        0x3,        0x1};
...
int Simulator::doSimulation(int start)
{
  ...
  while (1) {
    ...
    } while (pc != 0 && pc != 0xa00200a8 &&
             n_inst < 100000000); // Apparently, return from main function is always at address 0x4000074
