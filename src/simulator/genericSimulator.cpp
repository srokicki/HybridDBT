...
ac_int<64, false> GenericSimulator::solveSyscall(ac_int<64, false> syscallId, ac_int<64, false> arg1,
                                                 ac_int<64, false> arg2, ac_int<64, false> arg3, ac_int<64, false> arg4)
{
...
ac_int<64, false> GenericSimulator::doWrite(ac_int<64, false> file, ac_int<64, false> bufferAddr,
                                            ac_int<64, false> size)
{
  int localSize     = size.slc<32>(0);
  char* localBuffer = (char*)malloc(localSize * sizeof(char));
...
ac_int<64, false> GenericSimulator::doOpenat(ac_int<64, false> dir, ac_int<64, false> path, ac_int<64, false> flags,
