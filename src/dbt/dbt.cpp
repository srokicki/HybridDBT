...
=======
				if ((maxScheduleCount == -1 || blockScheduleCounter < maxScheduleCount) && OPTLEVEL >= 1 && block->sourceEndAddress - block->sourceStartAddress > 8  && block->blockState < IRBLOCK_STATE_SCHEDULED){
>>>>>>> Stashed changes
