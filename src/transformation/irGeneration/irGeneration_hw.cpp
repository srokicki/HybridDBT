                            ...
                            ac_int<32, true> globalVariables[128], ac_int<32, false> globalVariableCounter)
{
  ...
  do {
    ...
    ac_int<1, false> isLoadType = opcode == VEX_LDB | opcode == VEX_LDBU | opcode == VEX_LDH | opcode == VEX_LDHU |
    ...
    ac_int<1, false> isBranchWithTwoReg = opcode == VEX_BR | opcode == VEX_BRF | opcode == VEX_BGE | opcode == VEX_BLT |
