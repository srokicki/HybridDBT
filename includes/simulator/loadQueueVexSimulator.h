...
public:
	...
	ac_int<1, false> stbSpec(ac_int<64, false> addr, ac_int<8, true> value, unsigned char bankId);
	ac_int<1, false> sthSpec(ac_int<64, false> addr, ac_int<16, true> value, unsigned char bankId);
	ac_int<1, false> stwSpec(ac_int<64, false> addr, ac_int<32, true> value, unsigned char bankId);
	ac_int<1, false> stdSpec(ac_int<64, false> addr, ac_int<64, true> value, unsigned char bankId);

	ac_int<8, true> ldbSpec(ac_int<64, false> addr, unsigned char bankId);
	ac_int<16, true> ldhSpec(ac_int<64, false> addr, unsigned char bankId);
	ac_int<32, true> ldwSpec(ac_int<64, false> addr, unsigned char bankId);
	ac_int<64, true> lddSpec(ac_int<64, false> addr, unsigned char bankId);
